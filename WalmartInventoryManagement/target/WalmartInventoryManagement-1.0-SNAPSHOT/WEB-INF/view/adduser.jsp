                ...
                <div class="col-sm-12 col-md-12 well" id="content">
                    ...
                    <!-- Icon -->
                        <div id="formHeader">
                            ...
                            Enter the details to create new user.
                            
                            
                        </div>
                            

                        <form:form id="regForm" modelAttribute="User" action="processUser" method="POST">
                            <form:input path="userName" class="fadeIn second" placeholder="User Name" name="userName"/>
                            ...
                            <form:password path="confirmPassWord" class="fadeIn second" placeholder="Confirm PassWord" name="confirmPassWord"/>
