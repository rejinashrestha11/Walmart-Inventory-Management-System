            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                    ...
                    <!-- Icon -->
                        ...
                        <form:form id="regForm" modelAttribute="customer" action="processCustomer" method="POST">
                            <form:input path="customerId" class="fadeIn second" placeholder="Customer Id" name="customerId"/>
                            <form:input path="customerName" class="fadeIn second" placeholder="Customer Name" name="customerName"/>
                            <form:input path="address" class="fadeIn second" placeholder="Address" name="address"/>
                            <form:input path="contactNo" class="fadeIn second" placeholder="Contact Number" name="contactNo"/>
                            <form:input path="PAN_no" class="fadeIn second" placeholder="PAN Number" name="PAN_no"/>
                            <form:input path="billNo" class="fadeIn second" placeholder="Bill Number" name="billNo"/><br>
                            <form:button id="register" class="fadeIn fourth" name="register">Add</form:button>
                        </form:form>
                        <div id="formFooter">
                            ${message}
                        </div>
