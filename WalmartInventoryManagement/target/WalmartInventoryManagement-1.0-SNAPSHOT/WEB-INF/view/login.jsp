...
<html>
        ...
        <body>
            ...
            <div class="wrapper fadeInDown">
                <div id="formContent">
                    <img src="${pageContext.request.contextPath}/resources/images/Walmart.PNG" alt="LOGO" >
            
                <!-- Tabs Titles -->
                <h4>Please Login First!</h4>
               <form:form id="regForm" method="POST" modelAttribute="command" action="loginProcess">
