                ...
                <div class="col-sm-12 col-md-12 well" id="content">
                    ...
                    <!-- Icon -->
                        ...
                        <form:form id="regForm" modelAttribute="product" action="processProduct" method="POST">
                            <form:input path="PAN_no" class="fadeIn second" placeholder="PAN No./ TPIN No." name="PAN_no"/>
                            <form:input path="customerName" class="fadeIn second" placeholder="Customer Name" name="productName"/>
                            <form:input path="productId" class="fadeIn second" placeholder="Product Id" name="quantity"/>
                            <form:input path="quality" class="fadeIn second" placeholder="Quantity" name="sellingPrice"/>
                            <form:input path="tax_amt" class="fadeIn second" placeholder="Added Tax" name="costPrice"/><br>
                            <form:input path="amount" class="fadeIn second" placeholder="Amount" name="costPrice"/><br>
