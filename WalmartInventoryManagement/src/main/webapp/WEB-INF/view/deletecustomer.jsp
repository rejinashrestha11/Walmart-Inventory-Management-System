...
<!--                            <img src="${pageContext.request.contextPath}/resources/images/logo.png" id="icon" alt="User Icon" />-->
                        ...
                        <form:form method="POST" modelAttribute="customer" action="processdeletecustomer">
                        <form:input id="login" class="fadeIn second" placeholder="Customer Id" path="customerId"/>
